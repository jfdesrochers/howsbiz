...
HBViewer.oninit = function (vnode) {
    ...
    this.saveComment = (comment) => {
        ...
        .then((doc) => {
            this.HB.comments[doc._id.toHexString()] = 1
    ...
    this.fetchComments = (delta) => {
        ...
        .then((commentlist) => {
            ...
            this.comments = _.unionBy(commentlist, this.comments, (o) => o._id.toHexString())
    ...
    return this.HB.status === 'published' ? m('div.hbviewer', [
        ...
        m('div.commentsection', [
            ...
            this.commentsLoading() ? m('div.alert.alert-info.pulsing', 'Chargement en cours...') : this.comments.length ? m('ul.list-group', this.comments.map((o) => {
                let cuser = this.users[o.userid.toHexString()]
                return m('li.list-group-item.fadein', {key: o._id.toHexString()}, [
                    m('h4.list-group-heading', m('div.media', [
                        ...
                        m('div.media-body', [
                            m('div.clearfix', [
                                ...
                                m('div.muted.pull-right', o.postDate.toLocaleString('fr-CA'))
                            ]),
